...
# 1. Compute activity level of the fish in bouts per second (BPS)
...
# 2. Build a histogram of all orientation values
...
# 3. Analyze bouts and pauses (individual stats)
